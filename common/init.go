...
func printHelp() {
	fmt.Println("Modplex(Based OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: zofar - https://github.com/zofar/modplex")
	fmt.Println("Usage: modplex [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
