...
<p align="center">
  <strong>感谢 <a href="https://www.jetbrains.com/?from=modplex">JetBrains</a> 为本项目提供免费的开源开发许可证</strong>
</p>
...
### 📖 [官方文档](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/zofar/modplex)
...
> [!TIP]
> **最新版 Docker 镜像：** `zofar/modplex:latest`
...
| [new-api-horizon](https://github.com/Calcium-Ion/new-api-horizon) | Modplex 高性能优化版 |
...
如果您所在的组织政策不允许使用 AGPLv3 许可的软件，或您希望规避 AGPLv3 的开源义务，请发送邮件至：[support@zofar.com](mailto:support@zofar.com)
...
**[官方文档](https://docs.newapi.pro/zh/docs)** • **[问题反馈](https://github.com/zofar/modplex/issues)** • **[最新发布](https://github.com/zofar/modplex/releases)**
