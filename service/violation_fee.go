...
func HasCSAMViolationMarker(err *types.ModplexError) bool {
	if err == nil {
		return false
	}
...
func WrapAsViolationFeeGrokCSAM(err *types.ModplexError) *types.ModplexError {
	if err == nil {
		return nil
	}
...
func NormalizeViolationFeeError(err *types.ModplexError) *types.ModplexError {
	if err == nil {
		return nil
	}
...
func shouldChargeViolationFee(err *types.ModplexError) bool {
	if err == nil {
		return false
	}
...
func ChargeViolationFeeIfNeeded(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, apiErr *types.ModplexError) bool {
