...
import (
	...
	"github.com/zofar/modplex/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "modplex:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "modplex:channel_affinity_usage_cache_stats:v1"
)
