...
本文档提供使用宝塔面板 Docker 功能部署 Modplex 的图文教程。
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/modplex`
...
services:
  modplex:
    image: zofar/modplex:latest
    container_name: modplex
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
- [GitHub 仓库](https://github.com/zofar/modplex)
