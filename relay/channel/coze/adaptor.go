...
import (
	...
	"github.com/zofar/modplex/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.ModplexError) {
	if info.IsStream {
