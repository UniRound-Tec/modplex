...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-modplex-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-modplex-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-modplex-container') return true;
      return (
