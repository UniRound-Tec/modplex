# Modplex Electron Desktop App

This directory contains the Electron wrapper for Modplex, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., modplex-macos)
cp ../modplex-macos ../modplex
```
...
- Store database in `../data/modplex.db`
...
### Database Location
- **Development**: `../data/modplex.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Modplex/data/`
  - Windows: `%APPDATA%/Modplex/data/`
  - Linux: `~/.config/Modplex/data/`
